...
def mainMenu
    ...
    puts "Hello, quelle question aimerais-tu poser?"
    ...
    puts "
          ...
          6: Trie la liste de handle par taille des handles (les plus petits en premiers, les plus grands après)
...
def trois
    ...
    puts Journalists.count {|journalist| journalist.size==6}
    puts ""
    mainMenu
end
...
def quatre
    ...
    puts Journalists.count {|journalist| journalist =~ /^@[A-Z]/}
    puts ""
    mainMenu
end
...
def cinq
    ...
    puts Journalists.sort { |a, b| a.casecmp(b)}
    puts ""
    mainMenu
end

def six
    puts "Trie la liste de handle par taille des handles (les plus petits en premiers, les plus grands après)"
...
def huit
    ...
    34.times do |i|
        puts "Nombre de Handle avec #{i} caractères : #{Journalists.count {|journalist| journalist.size==i}}"
        puts ""
        i += 1
    end
    mainMenu
